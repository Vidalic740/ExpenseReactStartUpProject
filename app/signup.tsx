...
export default function SignUpScreen() {
  ...
  const handleSignUp = async () => {
    ...
    try {
      const response = await fetch('http://192.168.70.247:3000/api/auth/register', {
        method: 'POST',
        ...
        <View style={styles.accountTypeWrapper}>
          <TouchableOpacity
            ...
            style={[
              ...
              {
                backgroundColor: accountType === 'personal' ? colors.accent : colors. surface,
          ...
          >
            <Text
              style={[
                ...
                { color: accountType === 'personal' ? '#fff' : colors.text },
              ]}
            >
              Personal
            </Text>
          ...
          <TouchableOpacity
            ...
            style={[
              styles.accountTypeBtn,
              {
                backgroundColor: accountType === 'business' ? colors.accent : colors.surface,
                borderColor: colors.border,
              },
            ]}
          >
            <Text
              style={[
                styles.accountTypeText,
                { color: accountType === 'business' ? '#fff' : colors.text },
              ]}
            >
              Business
            </Text>
